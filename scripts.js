...
function signInCallback(authResult) {
  if (authResult['access_token']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:10493e6c-7b96-4469-82e6-8be747842799', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function testAWS() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-1mdeyvr3pghjv" // MAKE SURE YOU REPLACE THIS
  }; 
